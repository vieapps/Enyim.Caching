...
- Fully async with multiple nodes supported (unlike EnyimMemcachedCore (support only single node) this supports multiple nodes just like the original EnyimMemcached does)
