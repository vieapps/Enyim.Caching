...
namespace Enyim.Caching.Memcached.Protocol.Text
{
	internal static class TextSocketHelper
	{
		...
		/// using the <see cref="Enyim.Caching.Memcached.PooledSocket.Send(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/>
		/// </summary>
		...
		/// and use the <see cref="Enyim.Caching.Memcached.PooledSocket.Send(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/> to send the command and the additional buffers in one transaction.</remarks>
